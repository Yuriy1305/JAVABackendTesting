...
public class ExampleTest extends AbstractTest {
    ...
    // hash для входа ранее авторизированного пользоателя yuriy1305 (взято из профиля = из Postman):
    private static final String hashYuriy1305 = "b5b9315a52d967293d78c4a875641bb7a14615a7";

    @BeforeAll
// для автомат. логирования запроса и ответа при непрохождении тестов:
    static void setUp() {
        RestAssured.enableLoggingOfRequestAndResponseIfValidationFails();
    }
//       static void beforeAll() {
//        RestAssured.filters(new AllureRestAssured()); // логирование >mvn clean test allure:serve
//    }
...
// 1й GET из HW2 - код 200 и рецепты нашли:
        Integer totalResults = given()
                ...
                .jsonPath()
                .get("totalResults");
        // простая проверка найденного (статус -выше):
        if (totalResults > 0) {
